...
# training_opt['sampler'] = {'alpha': 1.0, 'cycle': 0, 'decay_gap': 3, 'def_file': './data/ClassPrioritySampler.py',
#     'epochs': 10, 'fixed_scale': 1, 'lam': None, 'manual_only': True, 'momentum': 0.0, 'nroot': None,
