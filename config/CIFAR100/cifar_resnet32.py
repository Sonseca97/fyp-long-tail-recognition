...
training_opt = {}
training_opt['dataset'] = 'CIFAR100_LT'
training_opt['log_dir'] = './logs/CIFAR100_LT'
...
training_opt['learning_rate'] = 0.01
...
feature_optim_param = {'lr': 0.01, 'momentum': 0.9, 'weight_decay': 2e-4}
...
classifier_param = {'feat_dim': training_opt['feature_dim'], 'num_classes': training_opt['num_classes'],
                    'stage1_weights': False, 'dataset': training_opt['dataset']}
classifier_optim_param = {'lr': 0.01, 'momentum': 0.9, 'weight_decay': 2e-4}
